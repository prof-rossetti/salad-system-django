"""
Django settings for salad_system project.
...
SECRET_KEY = 'j6x42hicotppm)z-1jm0zvy*d+@_0)as^#w)%)$#oxq^f7sc4i'
...
ROOT_URLCONF = 'salad_system.urls'
...
WSGI_APPLICATION = 'salad_system.wsgi.application'
